...
micaiah.update_attribute(:address, Address.create(line1: '1 Kadayanallur St', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: micaiah.id))
...
lyndis.update_attribute(:address, Address.create(line1: '56 North Bridge Road', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: lyndis.id))
...
isadora.update_attribute(:address, Address.create(line1: '64 Hillview Ave', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: isadora.id))
...
sakura.update_attribute(:address, Address.create(line1: '24 Lower Delta Road', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: avatar.id))
...
mai.update_attribute(:address, Address.create(line1: '77 Bedok Reservoir View', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: mai.id))
...
maria.update_attribute(:address, Address.create(line1: '14 Nanyang Crescent', line2: '#16-174', city: 'Singapore', country_subdivision: 'sg', postal_code: '174744', country: 'SGP', user_id: maria.id))
