...
dish_7 = Dish.create(name: 'Italian Bruschetta', price: 7.99, quantity: 10, category: 'Western, Italian, Bread, Tomato', owner_id: sakura.id, last_order: 3.hours.from_now, description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.')
dish_7.images << Image.create(name: 'dish_7_1.jpg')
dish_7.images << Image.create(name: 'dish_7_2.jpg')

dish_8 = Dish.create(name: 'Chicken Adobo', price: 7.99, quantity: 10, category: 'Filipino, Asian, Chicken, Rice', owner_id: sakura.id, last_order: 3.hours.from_now, description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.')
...
Place.delete_all
Place.create(address: '18 Raffles Quay Singapore 048582', timeslot: '5pm', area: 'Raffles', owner_id: lyndis.id)
Place.create(address: 'Bishan MRT', timeslot: '6pm', area: 'Bishan', owner_id: lyndis.id)
Place.create(address: 'City Hall MRT', timeslot: '6:30 pm', area: 'City Hall', owner_id: lyndis.id)
Place.create(address: '1 Kadayanallur St, Singapore 069184', timeslot: '6pm', area:'Tanjong Pagar', owner_id: micaiah.id)
Place.create(address: 'Jurong East MRT', timeslot: '6pm', area: 'Jurong', owner_id: micaiah.id)
Place.create(address: 'Tiong Bahru MRT', timeslot: '6:30pm', area: 'Tiong Bahru', owner_id: micaiah.id)
Place.create(address: '83 Seng Poh Rd, Singapore 161057', timeslot: '6:30pm', area: 'Tiong Bahru',owner_id: isadora.id)
Place.create(address: 'City Hall MRT', timeslot: '6pm', area: 'City Hall', owner_id: isadora.id)
Place.create(address: 'Bishan MRT', timeslot: '6:30pm', area: 'Bishan', owner_id: isadora.id)
Place.create(address: '108 Habour Front Walk, Singapore 098585', area: 'Habour Front', timeslot: '6:30pm', owner_id: sakura.id)
Place.create(address: 'Harbour Front MRT', timeslot: '6pm',  area: 'Habour Front', owner_id: sakura.id)
Place.create(address: 'Serangoon MRT', timeslot: '6:30pm',  area: 'Serangoon', owner_id: sakura.id)
Place.create(address: '55 Havelock Road, Singapore 161585', area: 'Tiong Bahru', timeslot: '5:30pm', owner_id: mai.id)
